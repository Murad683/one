      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="liquid-glass liquid-glass-warp border rounded-2xl sm:rounded-3xl max-w-xl w-full p-0 relative overflow-hidden h-auto max-h-[85vh] sm:max-h-[90vh] flex flex-col shadow-2xl overscroll-contain"
            style={{
